...
export class NewTaskComponent implements OnInit, AfterViewInit, AfterViewChecked {
    ...
    ngAfterViewInit() {
        // this.regionMapService.init('write');
        // this.regionMapService.create(this.cmpTask._id);
        // this.regionMapService.afterDrawRect()
        //     .subscribe(() => {
